...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1jqaLe1ECs&bvid=BV1jqaLe1ECs&cid=500001610720432&p=7)
...
Boot框架，MYSQL数据库设计开发，充分保证系统的稳定性。系统具有界面清晰、操作简单，功能齐全的特点，使得海滨学院班级回忆录管理工作系统化、规范化。本系统的使用使管理人员从繁重的工作中解脱出来，实现无纸化办公，能够有效的提高海滨学院班级回忆录管理效率。
...
whole process of the development of class memoirs in Haibin University.
By analyzing the shortcomings of class memoirs management in Haibin
University, this paper creates a scheme of computer management of class
memoirs in Haibin University. This paper introduces the system analysis
part of the class memoir of Haibin University, including the feasibility
analysis. The system design part mainly introduces the system function
design and database design.

The functions of the class memoir administrator of Haibin college
include personal center, user information management, class committee
information management, class information management, joining class
management, news information management, class album management,
activity information management, donation information management, forum
information management and system information management. Users can
register, login, join classes, view all kinds of information, publish
forums, donate, etc. So it has certain practicability.
...
operation and complete functions, which makes the class memoir
management of Haibin University systematic and standardized. The use of
this system makes managers free from heavy work, realize paperless
office, and can effectively improve the efficiency of class memoir
management in Haibin college.

**Keywords:** Class Memoirs of Haibin College; Spring boot framework;
Mysql database
...
[1.1 研究背景 1](#__RefHeading___Toc2624)

[1.2研究目的 1](#__RefHeading___Toc19491)
...
[3.3系统界面分析 6](#__RefHeading___Toc27270)
...
[5.1.2 班委信息管理 17](#班委信息管理)

[5.1.3 班级信息管理 17](#班级信息管理)

[5.1.4 班级相册管理 18](#班级相册管理)

[5.2 用户和班委模块的实现 18](#用户和班委模块的实现)

[5.2.2 班委注册 18](#班委注册)

[5.2.3 班级信息管理 19](#班级信息管理-1)
...
[]{#__RefHeading___Toc2624 .anchor}1.1 研究背景
...
[]{#__RefHeading___Toc19491 .anchor}1.2研究目的
...
[]{#__RefHeading___Toc27270 .anchor}3.3系统界面分析
...
![](media/image9.png){width="6.370833333333334in"
...
![](media/image11.png){width="6.3694444444444445in" height="2.76875in"}
...
![](media/image13.png){width="5.28125in" height="5.302083333333333in"}
...
经过对上述测试结果分析，本系统符合用户需求。所有基本功能点实现，操作简单，操作流程简单合理，产品运行性能良好，是一款值得推广的海滨学院班级回忆录。
...
首先我要感谢此次指导我的老师，是他的及时纠正我在设计当中出现的问题，使得我的设计高质量完成。指导老师在我本次海滨学院班级回忆录的开发过程中，为程序、框架的设计、代码等方面以及论文设计提供了很多宝贵的意见，并且为我推荐了许多相关的资料，他的指导和建议使我受益匪浅，通过老师的耐心辅导和指点，我的论文顺利完成，在此，我表示深刻的感谢。
